...
format: 
  html:
    ...
    self-contained: true
  pdf:
    output-file: cleaning.pdf
    toc: true
    number-sections: false
    colorlinks: true
    code-overflow: wrap
  revealjs:
    output-file: cleaning_slides.html
...
::: {.column width="100%"}
::: {.content-visible when-format="revealjs"}
```{r echo = F, fig.env = "figure",out.height="100%", fig.align = "center", set.cap.width=T, fig.cap="[Image source](https://r4ds.hadley.nz/intro.html): @wickham_r_2023 (all rights reserved)"}
...
::: {.content-visible when-format="html"}
```{r echo = F, fig.env = "figure",out.width="100%", fig.align = "center", set.cap.width=T, fig.cap="[Image source](https://r4ds.hadley.nz/intro.html): @wickham_r_2023 (all rights reserved)"}
knitr::include_graphics(here::here("media/Wickham_tidyworkflow.png"))
```
:::
:::
...
Three rules [@wickham_r_2023]:

1.  Each variable is a column, each column is a variable
2.  Each observation is a row, each row is an observation
3.  Each value is a cell, each cell is a single value

```{r echo = F, fig.env = "figure",out.width="70%", fig.align = "center", set.cap.width=T, fig.cap=" [Image source:](https://r4ds.hadley.nz/data-tidy.html) @wickham_r_2023 (all rights reserved)"}
...
- `mutate()` also takes `.by = ` as an argument
  ...
  + as of `dplyr 1.1.0` version ([more info](https://dplyr.tidyverse.org/reference/dplyr_by.html))
...
```{r, echo = F}
df_lifetime <- df_lifetime |> 
  select(-new_column, -newer_column, -First, -Last)
```
